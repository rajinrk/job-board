...
const MOCK_JOBS: Job[] = [
  ...
  },
  {
    ...
    description:
      "Join our AI team to work on machine learning projects that solve real-world problems. As a Data Scientist, you'll analyze large datasets, build predictive models, and work with our engineering team to deploy ML solutions at scale. We're looking for someone with strong Python/R skills, experience with ML frameworks like TensorFlow or PyTorch, and knowledge of statistical analysis and data visualization.",
    remote: true,
  ...
  },
  {
    ...
    description:
      "Lead our digital marketing efforts to drive user acquisition and brand awareness. You'll manage multi-channel campaigns, analyze performance metrics, and optimize marketing funnels. We're looking for someone with experience in SEO/SEM, social media marketing, email campaigns, and marketing analytics tools like Google Analytics and HubSpot.",
    remote: true,
...
export const fetchJobs = async (page: number = 1): Promise<Job[]> => {
  // Simulate API delay
